...
class InkscapeImagickSvgRendererTest extends ImageTestCase
{
    ...
    public function transparent()
    {
        ...
        $renderer = new InkscapeImagickSvgRenderer();
    ...
    public function invalidColor()
    {
        ...
        $this->expectExceptionMessage('Unrecognized color string');
