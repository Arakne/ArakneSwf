...
class PathStyleTest extends TestCase
{
    ...
    public function hash()
    {
        ...
        $this->assertSame(new PathStyle(new Solid(new Color(125, 14, 0)), null, 0)->hash(), new PathStyle(new Solid(new Color(125, 14, 0)), null, 0)->hash());
        ...
        $this->assertNotSame(new PathStyle(null, new Color(125, 14, 0), 0)->hash(), new PathStyle(new Solid(new Color(125, 14, 0)), null, 0)->hash());
        $this->assertNotSame(new PathStyle(new Solid(new Color(125, 14, 0)), null, 0)->hash(), new PathStyle(new Solid(new Color(124, 14, 0)), null, 0)->hash());
        $this->assertNotSame(new PathStyle(new Solid(new Color(125, 14, 0)), null, 0)->hash(), new PathStyle(new Solid(new Color(125, 15, 0)), null, 0)->hash());
        $this->assertNotSame(new PathStyle(new Solid(new Color(125, 14, 0)), null, 0)->hash(), new PathStyle(new Solid(new Color(125, 14, 1)), null, 0)->hash());
