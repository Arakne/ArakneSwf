...
readonly class SwfTag
{
    ...
    public function parseTag(SwfTagPosition $tag): object
    {
        ...
        $ret = match ($tagType) {
            0 => $this->parseEndTag($bytePosEnd),
            1 => $this->parseShowFrameTag($bytePosEnd),
            2 => $this->parseDefineShapeTag($bytePosEnd, 1),
            4 => $this->parsePlaceObjectTag($bytePosEnd),
            5 => $this->parseRemoveObjectTag($bytePosEnd, 1),
            ...
            12 => $this->parseDoActionTag($bytePosEnd),
            ...
            22 => $this->parseDefineShapeTag($bytePosEnd, 2),
            23 => $this->parseDefineButtonCxformTag($bytePosEnd),
            24 => $this->parseProtectTag($bytePosEnd),
            26 => $this->parsePlaceObject2Tag($bytePosEnd, $this->swfVersion),
            28 => $this->parseRemoveObjectTag($bytePosEnd, 2),
            32 => $this->parseDefineShapeTag($bytePosEnd, 3),
            ...
            70 => $this->parsePlaceObject3Tag($bytePosEnd),
            ...
            83 => $this->parseDefineShapeTag($bytePosEnd, 4),
